    ...
    <form action="/crossoff" method="post">
        <label for="crossed-off-movie">
            ...
            <select name="crossed-off-movie">
              ...
              <option value="Unbearable Lightness of Being">Unbearable Lightness of Being</option>
              <option value="Entre Nous">Entre Nous</option>
...
def crossoff_movie():
    ...
    sentence = crossed_off_movie_element + " has been crossed off of your Watchlist!"
